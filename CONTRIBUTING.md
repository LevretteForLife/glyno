Contributing to Glyno Core
============================

The Glyno Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Glyno Core project, and is not to be
confused with overall Glyno Network Protocol consensus changes.

Whether a pull request is merged into Glyno Core rests with the project merge
...
Patches that change Glyno consensus rules are considerably more involved than
...
Where a patch set proposes to change the Glyno consensus, it must have been
...
The project leader is the release manager for each Glyno Core release.
