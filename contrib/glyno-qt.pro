...
RESOURCES += src/qt/glyno.qrc src/qt/glyno_locale.qrc

TRANSLATIONS += src/qt/locale/glyno_bg.ts \
                src/qt/locale/glyno_de.ts \
                src/qt/locale/glyno_en.ts \
                src/qt/locale/glyno_es.ts \
                src/qt/locale/glyno_fi.ts \
                src/qt/locale/glyno_fr.ts \
                src/qt/locale/glyno_it.ts \
                src/qt/locale/glyno_ja.ts \
                src/qt/locale/glyno_pl.ts \
                src/qt/locale/glyno_pt.ts \
                src/qt/locale/glyno_ru.ts \
                src/qt/locale/glyno_sk.ts \
                src/qt/locale/glyno_sv.ts \
                src/qt/locale/glyno_vi.ts \
                src/qt/locale/glyno_zh_CN.ts \
                src/qt/locale/glyno_zh_TW.ts
