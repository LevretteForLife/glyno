...
In order to support loading of multiple wallets in glyno-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is glyno.cpp.
...
Changes to glyno.cpp
----------------------
glyno.cpp is the entry point into glyno-qt, and as such, will require some minor modifications to provide hooks for
