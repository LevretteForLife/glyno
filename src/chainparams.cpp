...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000007abe55c9a6be1a2ce2ed3b7b231074aa9e50a4af679efb5710bac0410ad"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1529018953, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "IT was born !!! It's ALIVE !!  1529018953";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1529018953;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2115764;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000007abe55c9a6be1a2ce2ed3b7b231074aa9e50a4af679efb5710bac0410ad"));
        assert(genesis.hashMerkleRoot == uint256("0xf367a1a6a353dce7db625afe59227cf45b87ffcb877849c1fb9404476636839d"));

        vSeeds.push_back(CDNSSeedData("107.172.234.62", "107.172.234.62"));         // Single node address
        vSeeds.push_back(CDNSSeedData("198.23.221.100 ", "198.23.221.100 "));       // Single node address
        vSeeds.push_back(CDNSSeedData("107.172.234.59", "107.172.234.59"));       // Single node address
        
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 28);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 8);
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 212);
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x05)(0x6D)(0x24)(0x33).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x05)(0x61)(0x32)(0x2B).convert_to_container<std::vector<unsigned char> >();
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet glnitas addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet glnitas script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet glnitas BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet glnitas BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet glnitas BIP44 coin type is '1' (All coin's testnet default)
