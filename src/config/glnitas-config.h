/* src/config/glyno-config.h.  Generated from glyno-config.h.in by configure.  */
/* src/config/glyno-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.glyno.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Glyno Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Glyno Core 1.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "glyno"
