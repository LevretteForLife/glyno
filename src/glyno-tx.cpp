...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Glyno Core glyno-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  glyno-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded glyno transaction") + "\n" +
                               "  glyno-tx [options] -create [commands]   " + _("Create hex-encoded glyno transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded glyno transaction
