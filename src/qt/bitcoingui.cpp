                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Glyno Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Glyno address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and glyno: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGLN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Glyno Core"), this);
    aboutAction->setStatusTip(tr("Show information about Glyno Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Glyno"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Glyno addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Glyno addresses"));
    ...
    openAction->setStatusTip(tr("Open a Glyno: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Glyno Core help message to get a list with possible Glyno command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Glyno Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Glyno network", "", count));
}
...
{
    QString strTitle = tr("Glyno Core"); // default title
