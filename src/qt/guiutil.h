...
/** Utility functions used by the Glyno Qt UI.
 */
namespace GUIUtil
{
...
// Render Glyno addresses in monospace font
...
// Parse "glyno:" URI into recipient object, return true on successful parsing
