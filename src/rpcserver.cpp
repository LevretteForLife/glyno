...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Glyno features */
        {"glyno", "masternode", &masternode, true, true, false},
        {"glyno", "listmasternodes", &listmasternodes, true, true, false},
        {"glyno", "getmasternodecount", &getmasternodecount, true, true, false},
        {"glyno", "masternodeconnect", &masternodeconnect, true, true, false},
        {"glyno", "masternodecurrent", &masternodecurrent, true, true, false},
        {"glyno", "masternodedebug", &masternodedebug, true, true, false},
        {"glyno", "startmasternode", &startmasternode, true, true, false},
        {"glyno", "createmasternodekey", &createmasternodekey, true, true, false},
        {"glyno", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"glyno", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"glyno", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"glyno", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"glyno", "getmasternodescores", &getmasternodescores, true, true, false},
        {"glyno", "mnbudget", &mnbudget, true, true, false},
        {"glyno", "preparebudget", &preparebudget, true, true, false},
        {"glyno", "submitbudget", &submitbudget, true, true, false},
        {"glyno", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"glyno", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"glyno", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"glyno", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"glyno", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"glyno", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"glyno", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"glyno", "checkbudgets", &checkbudgets, true, true, false},
        {"glyno", "mnsync", &mnsync, true, true, false},
        {"glyno", "spork", &spork, true, true, false},
        {"glyno", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"glyno", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use glynod, or the -server option to glyno-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> glyno-cli " + methodname + " " + args + "\n";
}
